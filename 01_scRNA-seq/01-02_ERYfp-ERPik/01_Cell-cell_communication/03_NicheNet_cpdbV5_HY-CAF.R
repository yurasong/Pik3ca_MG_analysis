#####################################################################################
# NicheNet ligand prioritisation analysis: HY → CAF signalling
#
# Description:
...
#   hybrid epithelial (HY_BC/ER+)-to-fibroblast (CAF) signaling programs.
...
#     4. Define sender (HY_BC/ER+) and receiver (Fibroblast) populations
