#####################################################################################
# Monocle3 trajectory inference and pseudotime visualization (CTL epithelial subset)
#
# Description:
...
#   counts, and dimensional reduction (PCA→UMAP) is computed. A CTL-only subset
...
#     5. Subset CDS to CTL cells for trajectory learning
...
#   - The trajectory is learned on CTL cells only (sample == "CTL") to define
...
cds_erp <- cds[, colData(cds)$sample == "CTL"]
