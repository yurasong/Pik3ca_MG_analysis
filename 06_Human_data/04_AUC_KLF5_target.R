...
#   2. Build AUCell rankings and calculate AUC for the KLF5 target genes as geneset
...
#   - 01_Signature/KLF5_target.txt      : List of genes defining the signatures composed of target genes of KLF5
#
# Outputs:
...
# Geneset allocation
early_hy <- read.delim("01_Signature/KLF5_target.txt", h=F)
early_hy <- early_hy$V1
early_hy <- unique(early_hy)

geneSets <- GeneSet(early_hy, setName="KLF5_target_all")
